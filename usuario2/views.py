...
from usuario2.mixins import LoginYSuperUsuarioMixin, ValidarPermisosRequeridosMixin
from usuario2.models import Usuario
from usuario2.forms import CambiarPasswordForm
...
class ListadoUsuario(ValidarPermisosRequeridosMixin,ListView):
    model = Usuario
    template_name = 'usuarios/listar_usuarios.html'
    permission_required = ('usuario2.view_usuario','usuario2.add_usuario','usuario2.delete_usuario','usuario2.change_usuario')
