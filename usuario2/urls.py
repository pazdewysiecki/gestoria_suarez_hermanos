...
from usuario2.views import ListadoUsuario, RegistrarUsuario,ModalRegistrarUsuario, EditarUsuario, EliminarUsuario, CambiarPassword
from django.contrib.auth.decorators import login_required
from django.views.generic import TemplateView
from usuario2.views import InicioUsuarios
